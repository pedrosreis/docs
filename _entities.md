...
A phone number is required for registration and, when enabled, provides additional security to the user's account through the use of Two-Factor Authentication (2FA).

Property | Description
--------- | -----------
e164Masked | The masked representation of the phone number in E164 format.
id | A unique ID in the Bitreserve network identifying the phone.
